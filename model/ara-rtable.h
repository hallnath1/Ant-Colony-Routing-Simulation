...
public:
   ...
   * \param pheromone the number of hops
   ...
   * \param pheromone the number of hops
   */
  void SetPheromone (uint16_t pheromone)
  {
    m_pheromone = pheromone;
  }
  /**
   * Get the pheromone value
   * \returns the pheromone value
   */
...
private:
  ...
  uint32_t m_seqNo;
  /// Pheromone Count (number of hops needed to reach destination)
